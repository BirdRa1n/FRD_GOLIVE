...
export async function captureNativeSource(
    ...
    // Áudio do sistema por desktopCapturer só funciona em algumas plataformas
    // (ex.: Windows). Tenta com áudio; se falhar, cai para vídeo puro.
    if (opts.systemAudio) {
        try {
            ...
            // segue para captura só de vídeo
        }
    }
